...
class LabourwiseViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate {
    ...
    func callLabourWiseCostSummaryAPI(keyword: String!, startDate: String!, endDate: String!)  {
        ...
        ObeidiModelCostSummaryLabourWise.callCostSummaryRequset(keyword: keyword, startDate: startDate, endDate: endDate) {
            ...
            if success! {
                ...
                self.processSiteWiseCostSummaryResponse(apiResponse: result! as! ObeidiModelCostSummaryLabourWise)
    ...
    func processSiteWiseCostSummaryResponse(apiResponse: ObeidiModelCostSummaryLabourWise) {
